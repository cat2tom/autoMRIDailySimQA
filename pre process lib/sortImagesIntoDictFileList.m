function image_dict = sortImagesIntoDictFileList(new_added_file_list )
%{
...
Notice: the input for this version is ned added file list to the directory.
...
all_IMA_file=new_added_file_list;
