function output = getOutPut2(slice_file_name,image_center )
%{ 
...
output_reference_value=5.86;

ouput_low_value=5.86-5.86*0.07;

ouput_high_value=5.86+5.86*0.07;

if output<ouput_low_value || output> ouput_high_value
    
    
    output=output_reference_value;
end 
