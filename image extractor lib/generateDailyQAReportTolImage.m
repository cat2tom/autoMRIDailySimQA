function  pdf_report_file_name=generateDailyQAReportTolImage(daily_qa_cell,tol_file,tol_type)
%{
...
addjavapath('N:/PROJECTS/MRI Sim project/autoMRISimQA/javaJarFiles') % for compiling.
...
%%add all the images
 ...
 test_anchor=Anchor('Test')
 
 test_anchor.setReference('#link');
 
 test_p=Paragraph();
 
 test_p.add(test_anchor);
