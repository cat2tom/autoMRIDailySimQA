function [PIU,contrast] = getUniformityContrast(slice_file_name )
%{ 
...
area_ROI_water2=1; % 2 cm circle for contrast region
...
ind_centre=[y_center_px-22,x_center_px+22];% 22 pixel separation in y and x
