function [SNR,ghosting,output] = getSNRGhosting3(slice_file_name,image_center )
%{ 
...
snr_reference_value=1.78;

snr_low_value=1.78-1.78*0.08;

if SNR<snr_low_value
