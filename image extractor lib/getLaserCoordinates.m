function [laser_x,laser_y,laser_z]= getLaserCoordinates( slice_file_name )
%{
...
version history: on 20/07/2016, the laser for x and Z were modified to
