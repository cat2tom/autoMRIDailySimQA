function [PIU,contrast,output] = getUniformityContrast3(slice_file_name,image_center )
%{ 
...
output: PIU=100*(1-(maxS-minS)/(maxS+minS).ACR definition.
        Contrast=(meanConsratS-meanWater)/(meanConsratS+meanWater)   

11/10/2016. Version modified: the constrast baseline were adjusted to acocomdate the changes from 14/09/2016.
8/11/2016. Baselines were added.
...
piu_low_value=97.1-97.1*0.025;

if PIU<piu_low_value
    
    PIU=piu_reference;

end 

%14. Calculate contrast 
...
reference_value=0.797;

low_tolerance=0.015; % 1.5%

low_value=0.797-0.797*0.015;

if contrast<low_value
