function  generateMultiDailyQAReportTolDirImage(daily_qa_cell_multi,tol_file,tol_type,pdf_dir)
%{
...
for k=1:row
    ...
    pdf_report_file_name=generateDailyQAReportTolDirImage(daily_qa_cell,tol_file,tol_type,pdf_dir)
