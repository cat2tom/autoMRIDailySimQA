...
function autoMRISimQATrackOperatorFileWinTask(dirs)
%{
...
mat_file=dirs{9}; % the matfile to save the file names.


%create a conection and create the database if it does not exist.

[db_connection,~] = createSQLDataBaseLaser(database_path,database_name);
...
autoImageProcessLoopDatabaseLaserTrackFileWinTaskOldTimer(MRI_image_dir, qatrack_exe,db_connection,excel_output_file,pdf_report_output_dir,excel_tolerance_file,mat_file);
