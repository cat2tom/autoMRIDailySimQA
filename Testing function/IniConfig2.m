...
<link href="http://www.mathworks.com/matlabcentral/fileexchange/24992-ini-config/content/IniConfig.m" rel="canonical" />
...
<input type="submit" value="Go" class="formelem gobutton" >
      ...
      <ol id="access2">
  <li class="first">
    <a href="https://www.mathworks.com/accesslogin/createProfile.do?uri=http%3A%2F%2Fwww.mathworks.com%2Fmatlabcentral%2Ffileexchange%2F24992-ini-config%2Fcontent%2FIniConfig.m" id="create_account_link">Create Account</a>
  </li>
  <li>
    <a href="https://www.mathworks.com/accesslogin/index_fe.do?uri=http%3A%2F%2Fwww.mathworks.com%2Fmatlabcentral%2Ffileexchange%2F24992-ini-config%2Fcontent%2FIniConfig.m" id="login_link">Log In</a>
  </li>
</ol>
  ...
  <div class="manifest">
      ...
      <div id="download_zip_button">
            <div class="btnCont ctaBtn ctaBlueBtn btnSmall">
              <div class="btn download"><a href="https://www.mathworks.com/accesslogin/index_fe.do?uri=http%3A%2F%2Fwww.mathworks.com%2Fmatlabcentral%2Ffileexchange%2F24992-ini-config%2Fcontent%2FIniConfig.m" class="link--download" data-file-format="zip" data-logintodownload="true" title="Download Now">Download Zip</a></div>
            </div>
          </div>

      <p class="license">
      Code covered by the <a href="/matlabcentral/fileexchange/view_license?file_info_id=24992" popup="new_window height=500,width=640,scrollbars=yes">BSD License</a>
  ...
  <h3 class="highlights_title">Highlights from <br/>
    <a href="http://www.mathworks.com/matlabcentral/fileexchange/24992-ini-config" class="manifest_title">INI Config</a>
  </h3>
  <ul class='manifest'>
      <li class='manifest'><a href="http://www.mathworks.com/matlabcentral/fileexchange/24992-ini-config/content/IniConfig.m" class="class" title="Class">IniConfig.m</a></li>
    <li class="manifest_allfiles">
      <a href="http://www.mathworks.com/matlabcentral/fileexchange/24992-ini-config/all_files" id="view_all_files">View all files</a>
    </li>
  </ul>
  ...
  <div id="thumbnail" style="padding-bottom: 3px;">
    <a href="/matlabcentral/mlc-downloads/downloads/submissions/24992/versions/4/screenshot.png" border="0"><img itemprop="image" src="/responsive_image/150/0/0/0/0/cache/matlabcentral/mlc-downloads/downloads/submissions/24992/versions/4/screenshot.png" width=100 alt="image thumbnail"/></a>
  </div>


<div id="details">
  <h1 itemprop="name">INI Config</h1>
  <p id="author">
    by 
    <span itemprop="author" itemscope itemtype="http://schema.org/Person">
      <span itemprop="name"><a href="/matlabcentral/profile/authors/1764615-evgeny-pr" class="author_inline results_author" data-cp-link-id="1">Evgeny Pr</a>

<div class="profile mlc_author_popover" data-cp-popup-id="1" vocab="http://schema.org/" typeof="Person">
  <h3 class="profile__name" property="name"><a href="/matlabcentral/profile/authors/1764615-evgeny-pr">Evgeny Pr <span>(view profile)</span></a></h3>

    <div class="profile__image">
      <a href="/matlabcentral/profile/authors/1764615-evgeny-pr"><img src="/responsive_image/100/0/0/0/0/cache/matlabcentral/profiles/1764615.jpg" /></a>
    </div>
  <div class="profile__stats" typeof="CreativeWork">
    
  <ul>
    <li property="fileExchange">
      <span class="icon-fileexchange"></span> <a href="/matlabcentral/fileexchange/?term=authorid%3A65956"><span property="fileExchange_count">4</span> files</a>
    </li>
    <li property="downloads">
      <span class="icon-download"></span> <span property="downloads_count">139</span> downloads
    </li>
      <li property="rating">

        <div class="rating" title="4.73387">
          <div class="rate_scale">
            <div class="rated" property="aggregateRating" style="width: 94.67739999999999%">4.73387</div>
          </div>
        </div>
...
>
      ...
      <span id="date_updated">(Updated 
        <span itemprop="datePublished" content="2010-03-22">22 Mar 2010</span>)
      </span>
  </p>

  <p id="summary">The class for working with configurations of settings and INI-files. </p>
    ...
    <tr>
      <td class="file">
        <table cellpadding="0" cellspacing="0" border="0" class="fileview section">
          <tr class="title">
            <th><span class="heading">IniConfig.m</span></th>
          </tr>
          <tr>
            <td>
              <iframe id="content_iframe" style="width: 100%;min-height: 600px; border: none" onload="initIframe(this.id)" sandbox="allow-popups allow-same-origin " src="/matlabcentral/mlc-downloads/downloads/submissions/24992/versions/4/previews/IniConfig.m/index.html"></iframe>
              <script>
