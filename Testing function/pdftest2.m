...
%  cb.beginText()
%  
%  head_txt='LCTC MRI-Sim Daily QA Report';
%  
%  cb.setTextMatrix(width/2-100,height-30);% left and top (x,y) is the position where to write the text. 
%  
