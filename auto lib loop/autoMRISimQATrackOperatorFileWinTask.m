...
autoImageProcessLoopDatabaseLaserTrackFileWinTask(MRI_image_dir, qatrack_exe,db_connection,excel_output_file,pdf_report_output_dir,excel_tolerance_file);
