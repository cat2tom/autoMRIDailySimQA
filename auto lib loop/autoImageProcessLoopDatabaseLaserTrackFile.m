...
function autoImageProcessLoopDatabaseLaserTrackFile(image_dir_name, qatrack_exe, db_connection,excel_file,pdf_dir,tol_file2)
...
%            
            ...
            for k=1:row
              ...
              tmp_excel='N:/PROJECTS/MRISimProject/autoMRISimQA/dailyQAExcelReport/test.xlsx';
%             
              writeDailyQAToExcelFileLaser(tmp_excel,cell2);
%             
...
%              updateQAtrackOperator(qatrack_exe,cell,op_cell);    
             ...
             updateQAtrackOperatorExcel(qatrack_exe);
    ...
    if ~isempty(new_files)
       ...
       if rem(length(new_files),11)==0 % as 11images for each QA, then to see if all 10 images arrived.
           ...
           % added function to update QA track.
            ...
            writeDailyQAToExcelFileLaser(tmp_excel,cell3);
            
%             qatrack_exe2='C:/aitangResearch/MRISimQALaserNoImageClinicQATrackOperator/updateQATracker/dist/updateQATrack4.exe';
